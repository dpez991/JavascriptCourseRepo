// Atributos estaticos en JS y no estaticos
...
// Ambas clases heredan este atributo
console.log(persona1.email);
console.log(empleado1.email);
console.log(Persona.email); // La clase no puede acceder a el, porque es un atributo de objeto, 
// se trata como un valor static por eso es undefined
console.log(Empleado.email); // Mismo caso